        ...
        {tech.map((item, i) => (
          <div
            ...
            className={cn(
              ...
              item === 'Tailwind' && 'border border-yellow-500/60',
              ...
              item === 'Next Auth' && 'border border-green-500/60',
              item === 'PHP' && 'border border-green-500/60',
              item === 'WordPress' && 'border border-green-500/60',
              item === 'Laravel' && 'border border-green-500/60',
