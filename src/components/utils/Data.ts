...
export const projectCard: IProjectSectionCardData[] = [
  {
    id: 1,
    title: 'Outdoor Cooking Experts',
    techStack: 'Woocommerce,WordPress,B2C,Multilingual',
    imageUrl: 'main.jpg',
    href: '#',
  },
  {
    ...
    title: 'Nustone',
    techStack:
      'WooCommerce, CustomCalculator, CustomChat, Zoho, Typescript, Tailwind CSS',
    imageUrl: 'Nustonemain.png',
    href: '#',
  },
  {
    id: 3,
    ...
    techStack:
      'Mean Stack, React JS, Mongoose, Next.js 13, Next Auth, React Hook Form, Typescript, Tailwind CSS',
    imageUrl: 'main-5.png',
    href: '#',
  },
  {
...
export const moreProjects = [
  ...
  },
  {
    id: 2,
    title: 'Intellizy',
    techStack: 'WordPress, Chaim,',
    icon: 'turtle',
    href: 'https://intellizy.co.nz/',
  },
  {
    id: 3,
    title: 'Dezayno',
    techStack: 'WordPress, Rest API, React',
    icon: 'shirt',
    href: 'https://dezayno.com/',
  },

  {
    id: 4,
    title: 'Connetix tiles',
    techStack: 'WordPress, Payment gatewat plugin with multiple account',
    icon: 'toybrick',
...

  {
    ...
    techStack: 'WordPress, Custom Web Systems, Website Design',
    icon: 'manage',
    href: 'https://prmgroup.com.au/',
  },
];
