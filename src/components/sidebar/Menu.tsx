...
const Menu: FC<MenuProps> = ({}) => {
  ...
  return (
    ...
    >
      ...
      <List link="https://www.instagram.com/tejas20.12/" effect="slideUp">
        <Video /> Videos
      </List>
      ...
      <List
        target="_blank"
        link="https://www.instagram.com/tejas20.12/"
        effect="slideUp"
      >
        <Instagram color="#b5179e" /> Instagram
      </List>
      <List target="_blank" link="https://github.com/tejas0306" effect="slideUp">
        <Github color="#2a9d8f" /> Github
      </List>
      {<List
        target="_blank"
        link="https://wordpress.stackexchange.com/users/155971/tejas-gajjar"
        effect="slideUp"
      >
        <Layers color="#0277b5" /> WordPress Stack Exchange
      </List>}
      <List
        target="_blank"
        link="https://stackoverflow.com/users/7440996/tejas-gajjar"
        effect="slideUp"
      >
      ...
      <List
        target="_blank"
        link="https://www.linkedin.com/in/gajjar-tejas/"
        effect="slideUp"
      >
